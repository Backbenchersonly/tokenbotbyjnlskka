...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7998091148:AAFlfnOb16ckTSIna7y7GwX_t3efzvZ4sYg")
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/Backbencherskabackupchannel/14")
